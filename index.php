        ...
        <div class="row">
          <div class="col-12 col-md-6 d-flex justify-content-center get-started" style="height: 550px;">
            <div class=" d-flex justify-content-center align-items-center">
              <div>
                <div class="big-title">
                  <h1> transforming how we learn and grow</h1>
                  <h1>Step into tomorrow.</h1>
                </div>
                <p class="text">
                  Optimize workflows, oversee resources, monitor student information, support communication, and improve the efficiency of administrative operations.
                </p>
                <div class="cta">
